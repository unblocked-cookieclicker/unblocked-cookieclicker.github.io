...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(me)
				{
					...
					//set image
					var bgPic=Game.resPath+'img/goldCookie.webp';
					...
					{
						me.wrath=1;
						if (Game.season=='halloween') bgPic=Game.resPath+'img/spookyCookie.webp';
						else bgPic=Game.resPath+'img/wrathCookie.webp';
					}
					else
					{
						me.wrath=0;
					...
					{
						bgPic=Game.resPath+'img/hearts.webp';
						picX=Math.floor(Math.random()*8);
					}
					else if (Game.season=='fools')
					{
						bgPic=Game.resPath+'img/contract.webp';
						if (me.wrath) bgPic=Game.resPath+'img/wrathContract.webp';
					}
					else if (Game.season=='easter')
					{
						bgPic=Game.resPath+'img/bunnies.webp';
			...
			'reindeer':{
				...
				initFunc:function(me)
				{
					...
					me.l.style.backgroundImage='url('+Game.resPath+'img/frostedReindeer.webp)';
					me.l.style.opacity='0';
				...
				this.draw=function()
				{
					...
					*/
					...
					for (var i=0;i<len;i++)
					{
						...
						{
							ctx.drawImage(Pic('youLight.webp'),pic.x+11,0);
		...
		new Game.Object('You','You|You|cloned|[X] optimized gene|[X] optimized genes','You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.',20,35,{pic:'you.webp',bg:'youBackground.webp',xV:0,yV:0,w:64,rows:2,x:0,y:0},12345678987654321,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		Game.last.descFunc=function(){
			...
			var x=Game.T;
			return this.desc+'<q>'+loc("Everyone's here.")+'<div id="parade" style="position:absolute;left:-11px;right:-11px;height:32px;background:url('+Game.resPath+'img/parade.webp) -'+x+'px '+(Game.T%20<10?0:32)+'px;"></div><div style="margin-bottom:32px;"></div>'+loc("Won't you have some cookies too?")+'</q>';
		};
		...
		Game.DrawBackground=function()
		{
			...
			else
			{
				...
				if (Game.drawT%5==0)
				{
					...
					{
						//l('backgroundCanvas').style.background='url('+Game.resPath+'img/shadedBordersSoft.webp) 0px 0px,url('+Game.resPath+'img/bgWheat.webp) 50% 50%';
				...
				if (Game.AscendTimer==0)
				{
					...
					if (Game.Has('Shimmering veil [off]'))
					{
						...
						ctx.drawImage(Pic('shimmeringVeil.webp'),-s/2,-s/2,s,s);
						ctx.restore();
						if (Game.prefs.particles)//sparkles
						{
							for (i=0;i<6;i++)
							{
								...
								ctx.drawImage(Pic('glint.webp'),xx-size/2,yy-size/2,size,size);
							}
						}
						ctx.globalCompositeOperation='source-over';
					}
