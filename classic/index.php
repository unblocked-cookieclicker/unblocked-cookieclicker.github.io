...
<script type="text/javascript">
    window.cookieconsent_options = {"message":"Unsurprisingly, this website uses cookies for ads and traffic analysis.","dismiss":"Got it!","learnMore":"Learn more","link":"https://w3technic.com/privacy-policy","target":"_blank","theme":"http://orteil.dashnet.org/cookieconsent.css","domain":"cookieclicker.ee"};
</script>

<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/cookieconsent2/1.0.9/cookieconsent.min.js"></script>

<title>Play Cookie Clicker Online <?php echo date("Y")?></title>
...
<link rel="canonical" href="//cookieclicker.ee" />
...
<div id="wrapper">
	...
	<div id="topBar">
		<div><b>Cookie Clicker</b>&trade; &copy; <a href="#" target="_blank" id="topbarOrteil">Orteil</a>, 2019 - <a href="#" target="_blank" id="topbarDashnet">DashNet</a></div> 
		<div><a href="https://www.facebook.com/cookieclicker.ee/" target="_blank" id="topbarTwitter">facebook</a></div>
		<div><a href="https://cookieclickernew.tumblr.com/" target="_blank" id="topbarTumblr">tumblr</a></div><div style="opacity:0">
		<!--<div><a href="http://forum.dashnet.org" target="_blank">Official forum</a></div>-->
		<div style="position:relative;"><div style="width:22px;height:32px;background:url(img/discord.png);position:absolute;left:0px;top:0px;pointer-events:none;"></div><a href="#" target="_blank" style="padding-left:16px;" id="topbarDiscord">Discord</a></div>
		<div style="position:relative;"><div style="width:25px;height:32px;background:url(img/weeHoodie.png);position:absolute;left:-2px;top:0px;pointer-events:none;"></div><a class="blueLink" href="#" target="_blank" style="padding-left:12px;" id="topbarMerch">Merch!</a></div>
		<div style="position:relative;"><div style="width:22px;height:32px;background:url(img/patreon.png);position:absolute;left:0px;top:0px;pointer-events:none;"></div><a class="orangeLink" href="#" target="_blank" style="padding-left:16px;" id="topbarPatreon">Patreon</a></div>
		...
		<div><a class="lightblueLink" style="font-weight:bold;" href="#" target="_blank" id="topbarMobileCC"></a></div>
		<div><a href="#" target="_blank" id="topbarRandomgen"></a></div>
		<div><a href="#" target="_blank" id="topbarIGM"></a></div>
		</div>
		...
		<div id="links" class="hoverer">
			...
			<a href="#beta" id="linkVersionBeta">Try the beta!</a>
			<a href="#" id="linkVersionOld">v. 1.0466</a>
			<a href="#">Classic</a>
			</div>
		</div>
	</div>
...
<div id="side-navigation">
		...
		<div id="menuToggle">
		  <input type="checkbox" aria-label="Show or Hide Menu" id="checkbox1" onclick="menuClick()" />
			<span></span>
			<span></span>
			<span></span>
...
<div id="left-column">	<!-- Nav Success -->
	<ul id="menu1">

	  <?php 
		$gamelist = $dbh->query("SELECT * FROM `game` WHERE 1=1 ORDER BY `sort` ASC LIMIT 100")->fetchAll();
	  ...
	  foreach ($gamelist as $item){
			...
			//echo strpos("I love php, I love php too!","2123");
			
			
			
			if($pos !== false){
				echo '<li class="active"><img src="'.$item['thumb'].'" height="30px" width="30px"> <a href="'.$item['link'].'" title="'.$item['description'].'">'.$item['name'].'</a></li>';
				continue;
			}else{
				echo '<li><img src="'.$item['thumb'].'" height="30px" width="30px"> <a href="'.$item['link'].'" title="'.$item['description'].'">'.$item['name'].'</a></li>';
			}
