...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		var str='';
		str+='<style>'+
		'#grimoireBG{background:url(img/shadedBorders.webp),url(img/grimoireBG.webp);background-size:100% 100%,auto;position:absolute;left:0px;right:0px;top:0px;bottom:16px;}'+
